...
| **Helm** | `helm-ci.yml` | PR/push (`deploy/helm`, `deploy/argocd`, `deploy/observability`) | Argo CD validate, observability validate, Helm template (local/CI/prod/observability) |
