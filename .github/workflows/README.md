...
| **Helm** | `helm-ci.yml` | PR/push (`deploy/helm`, `deploy/argocd`, `deploy/observability`) | Argo CD validate, observability + PgBouncer validate, Helm template (local/CI/prod/observability) |
