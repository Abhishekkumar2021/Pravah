...
| Terraform (cloud) | Partial (beta) | `deploy/terraform/` AWS modules (VPC, EKS, RDS, ElastiCache, S3, optional MSK); reference stack + `terraform-init-rds.sh`; CI validate (`terraform-ci.yml`) |
