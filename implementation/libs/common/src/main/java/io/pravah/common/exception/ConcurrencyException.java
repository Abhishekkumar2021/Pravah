...
/**
 * Thrown when a concurrent modification conflict is detected. Typically caused by optimistic
 * locking failures.
 */
public class ConcurrencyException extends PravahException {
  ...
  public ConcurrencyException(String entityType, String entityId) {
    super(
        ...
        String.format(
            "%s '%s' was modified by another request. Please retry.", entityType, entityId));
