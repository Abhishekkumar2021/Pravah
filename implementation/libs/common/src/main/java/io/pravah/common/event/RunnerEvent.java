...
public sealed interface RunnerEvent extends DomainEvent {
  ...
  record RunnerOnline(UUID eventId, Instant occurredAt, TenantId tenantId, UUID runnerId)
      implements RunnerEvent {
    @Override
    public String eventType() {
  ...
  record RunnerBusy(
      UUID eventId, Instant occurredAt, TenantId tenantId, UUID runnerId, int activeJobs)
      implements RunnerEvent {
    @Override
    public String eventType() {
      return "runner.busy";
  ...
  record RunnerDraining(UUID eventId, Instant occurredAt, TenantId tenantId, UUID runnerId)
      implements RunnerEvent {
    @Override
    public String eventType() {
  ...
  record RunnerOffline(
      UUID eventId, Instant occurredAt, TenantId tenantId, UUID runnerId, String reason)
      implements RunnerEvent {
    @Override
    public String eventType() {
  ...
  record RunnerDeregistered(UUID eventId, Instant occurredAt, TenantId tenantId, UUID runnerId)
      implements RunnerEvent {
    @Override
    public String eventType() {
