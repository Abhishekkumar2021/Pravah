 ...
 *
 * <p>Domain events represent something that happened in the domain. They are immutable and should
 * contain all information needed to understand what happened.
 *
 * @see <a href="../../../../../../docs/lld/01-design-patterns.md">Design Patterns - Domain
 *     Events</a>
 * @see <a href="../../../../../../docs/adr/ADR-003-outbox-pattern.md">ADR-003: Outbox Pattern</a>
 */
public sealed interface DomainEvent
    permits PipelineEvent, RunEvent, JobEvent, TenantEvent, RunnerEvent, NotificationEvent {
  ...
  /**
   * Type identifier for routing and deserialization. Format: {aggregate}.{action} (e.g.,
   * "pipeline.created", "run.started")
   *
