...
public class RestApiConnector implements SourceConnector {
    ...
    private static class RestApiRecordIterator implements RecordIterator {
        ...
        RestApiRecordIterator(RestTemplate restTemplate, ObjectMapper objectMapper,
                              String baseUrl, HttpHeaders headers, String dataPath,
                              String paginationType, ReadOptions options) {
            ...
            switch (paginationType) {
                ...
                case "cursor" -> {
                    ...
                    url.append(hasParams || nextCursor != null ? "&" : "?")
                            .append("limit=").append(options.batchSize());
                }
            }
            ...
            switch (paginationType != null ? paginationType : "none") {
                ...
                case "offset", "page" -> {
                    ...
                    if (totalNode != null && !totalNode.isNull()) {
                        ...
                        hasMorePages = !currentBatch.isEmpty()
                                && currentBatch.size() >= options.batchSize();
                    }
                }
