...
public interface SourceConnector extends Connector {
  ...
  record FieldInfo(String name, String type, boolean nullable, String description) {}

  /** Options for reading data. */
  record ReadOptions(
      int batchSize, String cursor, Map<String, Object> filters, List<String> selectedFields) {
  ...
  record Record(Map<String, Object> data, String cursor, long emittedAt) {}
}
