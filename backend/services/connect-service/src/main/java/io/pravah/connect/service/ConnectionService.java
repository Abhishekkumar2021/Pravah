...
public class ConnectionService {
    ...
    public Connection create(UUID tenantId, CreateConnectionRequest request) {
        ...
        Connector connector = connectorRegistry.get(request.connectorId())
                .orElseThrow(() -> new IllegalArgumentException("Unknown connector: " + request.connectorId()));
    ...
    public Connection update(UUID tenantId, UUID connectionId, UpdateConnectionRequest request) {
        Connection connection = repository.findByIdAndTenantId(connectionId, tenantId)
        ...
        if (request.config() != null) {
            Connector connector = connectorRegistry.get(connection.getConnectorId())
                    .orElseThrow(() -> new IllegalStateException("Unknown connector: " + connection.getConnectorId()));
    ...
    public Connector.TestResult testConnection(UUID tenantId, UUID connectionId) {
        ...
        log.info("Connection test completed: connectionId={}, success={}, message={}",
                connectionId, result.success(), result.message());
