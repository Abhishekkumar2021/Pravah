...
/**
 * Specification for a connector type.
 * Describes the connector's capabilities, configuration schema, and metadata.
 */
public record ConnectorSpec(
    ...
    public static class Builder {
        ...
        public ConnectorSpec build() {
            return new ConnectorSpec(id, name, description, icon, category, type, mode,
                    version, configFields, capabilities, tags);
        }
    }
}
