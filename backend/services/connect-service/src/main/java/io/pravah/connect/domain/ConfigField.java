...
/**
 * Defines a configuration field for a connector.
...
public record ConfigField(
    ...
    public static class Builder {
        ...
        public ConfigField build() {
            return new ConfigField(name, label, description, type, required, defaultValue,
                    options, placeholder, group, order, dependsOn, condition);
        }
    }
}
