...
/**
 * OpenAPI documentation configuration for Notification Service (US-11.12).
 *
...
public class OpenApiConfig {
  ...
  public OpenAPI notificationServiceOpenAPI() {
    return new OpenAPI()
        .info(
            new Info()
                .title("Pravah Notification Service API")
                .description(
                    """
                    REST API for managing alert rules, notifications, and audit logs.
                    ...
                    ## Resources
                    - **Alert Rules**: Configure alerts for pipeline events
        ...
        .servers(
            List.of(
                new Server().url("http://localhost:8088").description("Direct service access"),
