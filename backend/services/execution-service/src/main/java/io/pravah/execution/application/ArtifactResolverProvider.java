 ...
 *
 * <p>Artifact references are resolved at execution time (deferred) from the jobs table.
 * The referenced stage must have already completed successfully within the same execution.
 *
...
public class ArtifactResolverProvider implements ValueResolverProvider {
    ...
    public Object resolve(ValueReference ref, ResolutionContext ctx) {
        ...
        String cacheKey = "artifact:" + artifactRef.stageId() + ":" + artifactRef.filename() + ":" + artifactRef.property();
    ...
    private Object resolveProperty(
            StageArtifactRef artifactRef,
            Map<String, Object> artifactMeta,
        ...
        return switch (property) {
            ...
            case "url" -> {
                PresignedUrlResponse presignedUrl = artifactStorageService.generateDownloadUrl(
            ...
            default -> throw new IllegalArgumentException(
                    "Unknown artifact property: " + property);
        };
    }
