...
/**
 * OpenAPI documentation configuration for Execution Service (US-11.12).
 *
...
public class OpenApiConfig {
  ...
  public OpenAPI executionServiceOpenAPI() {
    return new OpenAPI()
        .info(
            new Info()
                .title("Pravah Execution Service API")
                .description(
                    """
                    REST API for managing pipeline executions, jobs, and logs.
                    ...
                    ## Resources
                    - **Executions**: Start, monitor, cancel, and retry pipeline runs
                    - **Jobs**: View stage-level status and logs
                    - **WebSocket**: Real-time execution status updates at `/ws/executions`
                    """)
                .version("1.0.0")
        ...
        .servers(
            List.of(
                new Server().url("http://localhost:8084").description("Direct service access"),
